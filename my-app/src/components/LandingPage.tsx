...
import { BookOpen, Award, Users, ArrowRight, Star, Code } from 'lucide-react';
    ...
    <div className="min-h-screen bg-neutral-50">
      ...
      <header className="bg-white border-b border-neutral-200">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <nav className="flex items-center gap-8">
            ...
            <button className="px-5 py-2 bg-purple-900 text-white rounded-lg hover:bg-purple-800 transition-colors">
              Connect Wallet
            </button>
          </nav>
        </div>
          ...
          <div className="grid grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex gap-4">
                <button className="px-6 py-3 bg-neutral-900 text-white rounded-lg hover:bg-neutral-800 flex items-center gap-2 transition-colors">
                  Start Learning Free <ArrowRight size={20} />
                </button>
                <button className="px-6 py-3 border-2 border-neutral-300 text-neutral-900 rounded-lg hover:border-neutral-400 transition-colors">
                  Watch Demo
                </button>
              </div>
              <div className="flex items-center gap-8 mt-8 pt-8 border-t border-neutral-200">
                ...
                <div>
                  <div className="text-2xl font-bold text-neutral-900">4.9 stars</div>
              ...
              <div className="bg-gradient-to-br from-purple-100 to-blue-100 rounded-2xl shadow-2xl overflow-hidden border border-neutral-200">
                <div className="aspect-[4/3] flex items-center justify-center p-12">
                  <div className="text-center">
                    ...
                    <div className="text-6xl mb-4">Developer</div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <button className="px-4 py-2 bg-white border border-neutral-200 text-neutral-700 rounded-lg text-sm font-medium hover:bg-neutral-50 transition-colors">Wallet</button>
          <button className="px-4 py-2 bg-white border border-neutral-200 text-neutral-700 rounded-lg text-sm font-medium hover:bg-neutral-50 transition-colors">DeFi</button>
          <button className="px-4 py-2 bg-white border border-neutral-200 text-neutral-700 rounded-lg text-sm font-medium hover:bg-neutral-50 transition-colors">NFTs</button>
          <button className="px-4 py-2 bg-white border border-neutral-200 text-neutral-700 rounded-lg text-sm font-medium hover:bg-neutral-50 transition-colors">Terminology</button>
        </div>
        ...
        <div className="grid grid-cols-3 gap-6">
          {[
            { title: 'Everything you need to know about wallet connect', badge: 'IT & Software', rating: 4.8, students: '9,530 students', color: 'from-pink-100 to-red-100' },
            { title: 'Powerful Business Writing: How to Write Concisely', badge: 'Business', rating: 4.9, students: '1,493 students', color: 'from-orange-100 to-yellow-100' },
            { title: 'Certified Six Sigma Yellow Belt Training', badge: 'Management', rating: 4.9, students: '6,739 students', color: 'from-purple-100 to-blue-100' },
            { title: 'Figma UI Design: From Zero to Pro in 7 Days', badge: 'Design', rating: 5.0, students: '8,735 students', color: 'from-green-100 to-teal-100' },
            { title: 'Smart Contract Development with Clarity', badge: 'Blockchain', rating: 4.9, students: '5,240 students', color: 'from-blue-100 to-indigo-100' },
            { title: 'Web3 Frontend Development', badge: 'Development', rating: 4.8, students: '7,120 students', color: 'from-violet-100 to-purple-100' }
          ].map((course, i) => (
            <div 
              key={i} 
              className={`bg-white rounded-xl border border-neutral-200 overflow-hidden transition-all cursor-pointer ${
                hoveredCourse === i ? 'shadow-xl scale-105' : 'shadow-md'
              }`}
      ...
      <section className="bg-purple-900 py-20 mt-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-3 gap-8">
            {[
              { icon: 'Gamepad', title: 'Interactive Simulations', desc: 'Practice deploying contracts in a safe sandbox.' },
              { icon: 'Lightning', title: 'Micro-Lessons', desc: '5-10 minute lessons that fit your schedule.' },
              { icon: 'Target', title: 'Quest-Based Learning', desc: 'Complete missions and level up.' },
              { icon: 'Puzzle', title: 'Visual Code Blocks', desc: 'Drag and drop to build smart contracts.' },
              { icon: 'Robot', title: 'AI Learning Buddy', desc: 'Get help 24/7 when stuck.' },
              { icon: 'Trophy', title: 'Earn as You Learn', desc: 'Collect NFT badges for skills.' }
            ].map((method, i) => (
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                <div className="w-8 h-8 bg-purple-100 rounded-lg flex items-center justify-center">
                  <BookOpen className="text-purple-900" size={20} />
                </div>
